...
//Static Mac Address
static uint8_t mac[] = { 0x00, 0xAA, 0xBB, 0xCC, 0xDD, 0xF3 };  // Chambre enfant 0x02  //AA TEST //AR-01 FF
                                                                // master cuisine 0x04
// MQTT Settings //
...
#define NAME "AR-02" //nom publish pour l'adresse ip et le uptime
#define TOPIC "ch"
#define SLASH "/"
#define NAMEA "A"
#define NAMEB "B"
...
const char BOARD_TOPIC0[] PROGMEM = NAME SLASH TOPIC SLASH IP;
const char BOARD_TOPIC1[] PROGMEM = NAME SLASH TOPIC SLASH UPTIME;
...
const char DHT_TOPICA1[] PROGMEM = NAME SLASH TOPIC SLASH NAMEA SLASH CLIM SLASH MAIN SLASH;
const char DHT_TOPICA2[] PROGMEM = NAME SLASH TOPIC SLASH NAMEA SLASH CLIM SLASH CLOSET SLASH;
const char DHT_TOPICB1[] PROGMEM = NAME SLASH TOPIC SLASH NAMEB SLASH CLIM SLASH MAIN SLASH;
const char DHT_TOPICB2[]  PROGMEM = NAME SLASH TOPIC SLASH NAMEB SLASH CLIM SLASH CLOSET SLASH;
...
const char SUBRELAY0[] = NAME SLASH TOPIC SLASH NAMEA SLASH LIGHT SLASH MAIN SLASH STATUS SLASH;
const char SUBRELAY1[] = NAME SLASH TOPIC SLASH NAMEA SLASH LIGHT SLASH CLOSET SLASH STATUS SLASH;
const char SUBRELAY2[] = NAME SLASH TOPIC SLASH NAMEA SLASH HEAT SLASH MAIN SLASH STATUS SLASH;
const char SUBRELAY3[] = NAME SLASH TOPIC SLASH NAMEB SLASH LIGHT SLASH MAIN SLASH STATUS SLASH;
const char SUBRELAY4[] = NAME SLASH TOPIC SLASH NAMEB SLASH LIGHT SLASH CLOSET SLASH STATUS SLASH;
const char SUBRELAY5[] = NAME SLASH TOPIC SLASH NAMEB SLASH HEAT SLASH MAIN SLASH STATUS SLASH;;
const char* const SUBRELAY[] =  { SUBRELAY0, SUBRELAY1, SUBRELAY2 ,SUBRELAY3 ,SUBRELAY4 ,SUBRELAY5 };

const char COMRELAY0[] = NAME SLASH TOPIC SLASH NAMEA SLASH LIGHT SLASH MAIN SLASH COMMAND SLASH;
const char COMRELAY1[] = NAME SLASH TOPIC SLASH NAMEA SLASH LIGHT SLASH CLOSET SLASH COMMAND SLASH;
const char COMRELAY2[] = NAME SLASH TOPIC SLASH NAMEA SLASH HEAT SLASH MAIN SLASH COMMAND SLASH;
const char COMRELAY3[] = NAME SLASH TOPIC SLASH NAMEB SLASH LIGHT SLASH MAIN SLASH COMMAND SLASH;
const char COMRELAY4[] = NAME SLASH TOPIC SLASH NAMEB SLASH LIGHT SLASH CLOSET SLASH COMMAND SLASH;
const char COMRELAY5[] = NAME SLASH TOPIC SLASH NAMEB SLASH HEAT SLASH MAIN SLASH COMMAND SLASH;;
...
const char INPUTPUBLISH0[] PROGMEM = NAME SLASH TOPIC SLASH NAMEA SLASH SW SLASH MAIN SLASH SIMPLE SLASH;
const char INPUTPUBLISH1[] PROGMEM = NAME SLASH TOPIC SLASH NAMEA SLASH SW SLASH MAIN SLASH DOUBLE SLASH;
const char INPUTPUBLISH2[] PROGMEM = NAME SLASH TOPIC SLASH NAMEA SLASH SW SLASH MAIN SLASH LONG SLASH;
const char INPUTPUBLISH3[] PROGMEM = NAME SLASH TOPIC SLASH NAMEA SLASH SW SLASH CLOSET SLASH SIMPLE SLASH;
const char INPUTPUBLISH4[] PROGMEM = NAME SLASH TOPIC SLASH NAMEA SLASH SW SLASH CLOSET SLASH DOUBLE SLASH;
const char INPUTPUBLISH5[] PROGMEM = NAME SLASH TOPIC SLASH NAMEA SLASH SW SLASH CLOSET SLASH LONG SLASH;
const char INPUTPUBLISH6[] PROGMEM = NAME SLASH TOPIC SLASH NAMEB SLASH SW SLASH MAIN SLASH SIMPLE SLASH;
const char INPUTPUBLISH7[] PROGMEM = NAME SLASH TOPIC SLASH NAMEB SLASH SW SLASH MAIN SLASH DOUBLE SLASH;
const char INPUTPUBLISH8[] PROGMEM = NAME SLASH TOPIC SLASH NAMEB SLASH SW SLASH MAIN SLASH LONG SLASH;
const char INPUTPUBLISH9[] PROGMEM = NAME SLASH TOPIC SLASH NAMEB SLASH SW SLASH CLOSET SLASH SIMPLE SLASH;
const char INPUTPUBLISH10[] PROGMEM = NAME SLASH TOPIC SLASH NAMEB SLASH SW SLASH CLOSET SLASH DOUBLE SLASH;
const char INPUTPUBLISH11[] PROGMEM = NAME SLASH TOPIC SLASH NAMEB SLASH SW SLASH CLOSET SLASH LONG SLASH;
