...
const char SUBRELAY0[] = NAME SLASH TOPIC SLASH NAMEA SLASH RELAY SLASH ZERO SLASH STATUS SLASH;
const char SUBRELAY1[] = NAME SLASH TOPIC SLASH NAMEA SLASH RELAY SLASH UN SLASH STATUS SLASH;
const char SUBRELAY2[] = NAME SLASH TOPIC SLASH NAMEA SLASH RELAY SLASH DEUX SLASH STATUS SLASH;
const char SUBRELAY3[] = NAME SLASH TOPIC SLASH NAMEB SLASH RELAY SLASH ZERO SLASH STATUS SLASH;
const char SUBRELAY4[] = NAME SLASH TOPIC SLASH NAMEB SLASH RELAY SLASH UN SLASH STATUS SLASH;
const char SUBRELAY5[] = NAME SLASH TOPIC SLASH NAMEB SLASH RELAY SLASH DEUX SLASH STATUS SLASH;;
const char* const SUBRELAY[] =  { SUBRELAY0, SUBRELAY1, SUBRELAY2 ,SUBRELAY3 ,SUBRELAY4 ,SUBRELAY5 };

const char COMRELAY0[] = NAME SLASH TOPIC SLASH NAMEA SLASH RELAY SLASH ZERO SLASH COMMAND SLASH;
const char COMRELAY1[] = NAME SLASH TOPIC SLASH NAMEA SLASH RELAY SLASH UN SLASH COMMAND SLASH;
const char COMRELAY2[] = NAME SLASH TOPIC SLASH NAMEA SLASH RELAY SLASH DEUX SLASH COMMAND SLASH;
const char COMRELAY3[] = NAME SLASH TOPIC SLASH NAMEB SLASH RELAY SLASH ZERO SLASH COMMAND SLASH;
const char COMRELAY4[] = NAME SLASH TOPIC SLASH NAMEB SLASH RELAY SLASH UN SLASH COMMAND SLASH;
const char COMRELAY5[] = NAME SLASH TOPIC SLASH NAMEB SLASH RELAY SLASH DEUX SLASH COMMAND SLASH;;
