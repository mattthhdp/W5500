...
private:
  ...
  unsigned int _clickTicks = 350;   // number of msecs before a click is detected.
  unsigned int _pressTicks = 1500;   // number of msecs before a long button press is detected
